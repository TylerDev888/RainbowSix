...
const routes: Routes = [
  { path: '', redirectTo: 'playstation2/code-editor', pathMatch: 'full' },
  ...
  { path: 'ai/chat', component: AIChatPage, data: { title: 'AI Chat'} },
  { path: 'ai/image-generator', component: AIImageGeneratorPage, data: { title: 'AI Image Generator'} },
  ...
  { path: 'landing', component: LandingPage, data: { title: 'Landing'} },
  ...
  { path: 'r6/sell', component: SellComponent, data: { title: 'Sell' }},
