import { Component, OnDestroy, AfterViewInit, HostListener, OnInit } from '@angular/core';
...
export class ExtraDataManagementPage implements OnInit, OnDestroy, AfterViewInit {
  ngOnInit(): void {
  ...
  constructor(public appSettings: AppSettings, public signalrService: SignalrService) {
