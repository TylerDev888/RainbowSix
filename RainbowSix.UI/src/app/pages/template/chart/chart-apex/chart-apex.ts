  ...
  getChart1Options() {
		return {
			...
			dataLabels: {
				...
				background: {
					...
					borderRadius: 2,
					borderWidth: 0,
					borderColor: this.appVariables.color.white,
					opacity: 0.9,
					dropShadow: {
						enabled: false
					}
	...
	getChart3Options() {
		return {
			...
			dataLabels: { enabled: false },
			stroke: { curve: 'smooth', width: 3 },
			colors: [this.appVariables.color.pink, this.appVariables.color.inverse],
			series: [
	...
	getChart4Options() {
		return {
			...
			xaxis: {
				categories: [2018, 2019, 2020, 2021, 2022, 2023, 2025],
				axisBorder: {
					show: true,
					color: this.appVariables.color.borderColor,
					height: 1,
	...
	getChart5Options() {
		return {
			...
			dataLabels: { enabled: false },
			stroke: { width: [0, 0, 3] },
			colors: [this.appVariables.color.primary, this.appVariables.color.teal, this.appVariables.color.warning],
			title: {
				text: 'XYZ - Stock Analysis (2016 - 2025)',
				align: 'left',
				offsetX: 110,
				style: {
					fontSize: '14px',
			...
			xaxis: {
				categories: [2016, 2017, 2018, 2025, 2020, 2021, 2022, 2023, 2025],
				axisBorder: {
					show: true,
					color: this.appVariables.color.borderColor,
					height: 1,
